...
- The active pointer lives in [.active_engagement](.active_engagement); the gate hook deletes any
  pipeline write that targets a non-active engagement (context-bleed enforcement).
